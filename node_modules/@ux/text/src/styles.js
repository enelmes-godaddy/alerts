...
export default css`
  :global() {
    .ux-text {
      ...
      font-variation-settings: ${intents.uxText.fontVariation};
      ...
      &.ux-text-title {
        ...
        font-variation-settings: ${intents.uxText.title.fontVariation};
      }
      ...
      &.ux-text-heading {
        ...
        font-variation-settings: ${intents.uxText.heading.fontVariation};
      }
      ...
      &.ux-text-paragraph {
        ...
        font-variation-settings: ${intents.uxText.paragraph.fontVariation};
      }
      ...
      &.ux-text-action {
        ...
        font-variation-settings: ${intents.uxText.action.fontVariation};
      }
      ...
      &.ux-text-input {
        ...
        font-variation-settings: ${intents.uxText.input.fontVariation};
      }
      ...
      &.ux-text-label {
        ...
        font-variation-settings: ${intents.uxText.label.fontVariation};
      }
      ...
      &.ux-text-caption {
        ...
        font-variation-settings: ${intents.uxText.caption.fontVariation};
      }

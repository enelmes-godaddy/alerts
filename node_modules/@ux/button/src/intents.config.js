...
export default (function () {
  ...
  intents.create('@ux/button', {
    styleProperties: [
      ...
      enums.properties.OUTLINE_COLOR,
      enums.properties.BORDER_RADIUS,
      enums.properties.BORDER_WIDTH,
      enums.properties.LINE_HEIGHT
    ],
    expressions: [
      enums.expressions.PRIMARY,
      enums.expressions.SECONDARY,
      enums.expressions.CRITICAL,
      enums.expressions.CONTROL,
      'Link'
    ],
    interactions: [
      enums.interactions.FOCUSED,
      enums.interactions.HOVERED,
